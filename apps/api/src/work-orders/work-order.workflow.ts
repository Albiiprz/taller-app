...
const TRANSITIONS: Record<OtStatus, OtStatus[]> = {
  ...
  PRE_ENTRADA: ['PROGRAMADA', 'RECEPCION'],
  RECEPCION: ['PROGRAMADA', 'PRE_ENTRADA', 'DIAGNOSTICO'],
  ...
  REPARACION: ['DIAGNOSTICO', 'QC', 'LISTO_ENTREGA'],
  QC: ['LISTO_ENTREGA', 'REPARACION'],
  LISTO_ENTREGA: ['QC', 'REPARACION', 'ENTREGADO'],
